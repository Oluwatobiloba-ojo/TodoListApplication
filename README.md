Todolist
A todolist allows you to prioritize the tasks that are more important. 
This means you don't waste time on tasks that don't require your immediate attention. 
It also helps in showing you're the due date of task which is schedule on the todolist, 
...
GET
registerRequest
Register request is where the user can be able to register or create an account, 
it collects username and password, which is saved in database and return message
...
Response 2
unsuccessful request due to creating a user which already exist in the database
...
GET
createTaskRequest
This end-point is used create a task on the user to do list this request collect a from the user, username, message or description, dueDateTime and returns that task has been created.
...
{
"data": {
"message": "We have created the Task ooh"
},
"successful": true
}
Response 2
...
This is an end-point which is used for updating the due date of a task
